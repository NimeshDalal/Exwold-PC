...
namespace ITS.Exwold.Desktop
{
    internal static class Helper
    {
        ...
        internal async static Task<PackInformation.PackInfo> PackInfoAsync(DataInterface.execFunction db, int PalletBatchUId)
        {
            try
            {
                ...
                return new PackInformation.PackInfo(dsPackInfo);
            }
            catch { return new PackInformation.PackInfo(null); }
        }
