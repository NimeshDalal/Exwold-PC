...
namespace ExwoldPcInterface
{
  ...
  public partial class MainStatusForm : Form
  {
    ...
    {
      //Clear old data
      this.dataGridViewReadyToPrint.DataSource = null;
      this.dataGridViewReadyToPrint.Refresh();

      this.dataGridViewOnHold.DataSource = null;
      this.dataGridViewOnHold.Refresh();
      ...
      {
        this.dataGridViewReadyToPrint.DataSource = dtReadyToPrint;
      }
      ...
      {
        this.dataGridViewOnHold.DataSource = dtOnHold;
      }
